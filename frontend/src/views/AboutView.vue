      ...
      <div class="row">
        <div class="col-md-12">
          <div class="main-timeline9">
            <div class="timeline">
              <div class="timeline-content">
                ...
                <div class="content">
                  ...
                  <p class="description">
                    Студенты и сотрудники ЮФУ, которым не безразличны проблемы города, в сотрудничестве с Администрацией г. Таганрога и Ассоциацией "Brainhorn".
                  </p>
            ...
            <div class="timeline">
              <div class="timeline-content">
                <div class="circle"><img :src="icon_sfedunet" class="img-fluid rounded-circle"></div>
                <div class="content">
                  <span class="year">SfeduNet</span>
                  <!-- <h4 class="title">Web Developer</h4> -->
                  <p class="description">
                      Проект выполняется в рамках проектной деятельности обучающихся, в интенсиве "SfeduNet" ЮФУ. Большинство участников команды являются лаборантами СКБ "КИТ" ЮФУ.
                  </p>
                  <div class="icon"><span></span></div>
                </div>
              </div>
            ...
            <div class="timeline">
              <div class="timeline-content">
                <div class="circle"><img :src="icon_brainhorn" class="img-fluid rounded-circle"></div>
                <div class="content">
                  <span class="year">Brainhorn</span>
                  <!-- <h4 class="title">Web Desginer</h4> -->
                  <p class="description">
                      Ассоциация разработчиков цифровых решений. Основана ведущими IT-компаниями Таганрога: DUNICE, INOSTUDIO, LODOSS, OGGETTO. Также: DISTILLERY, REALLAB, CVISIONLAB и АКВАЗОНД.
                  </p>
                  <div class="icon"><span></span></div>
                </div>
              </div>
            ...
            <div class="timeline">
              <div class="timeline-content">
                ...
                <div class="content">
                  ...
                  <!-- <h4 class="title">Web Developer</h4> -->
                  <p class="description">
                    Студенческое конструкторское бюро «Компьютерное инновационное творчество» - это объединение научных лабораторий, развивающих передовые технологические направления в университете. Здесь студенты могут развивать способности к техническому творчеству, создавать реальные технологические проекты под руководством наставников из университета и бизнеса.
                  </p>
                  <div class="icon"><span></span></div>
                </div>
              </div>
            ...
            <div class="timeline">
              <div class="timeline-content">
                ...
                <div class="content">
                  ...
                  <!-- <h4 class="title">Web Developer</h4> -->
                  <p class="description">
                    город в Ростовской области России. Порт на берегу Таганрогского залива Азовского моря (в 66 км от областного центра — Ростова-на-Дону). Образует городской округ город Таганрог. Является самым западным городом области. Входит в список исторических поселений России.
                  </p>
                  <div class="icon"><span></span></div>
                </div>
              </div>
...
.main-timeline9 .timeline:first-child:before,.main-timeline9 .timeline:last-child:before{content:"";width:25px;height:25px;border-radius:50%;background:#fff;border:4px solid #95E375;position:absolute;top:0;right:-14px;z-index:1}
...
.main-timeline9 .timeline-content:before{content:"";width:100%;height:5px;background:#95E375;position:absolute;top:88px;left:0;z-index:-1}
.main-timeline9 .circle{width:180px;height:180px;border-radius:50%;background:#fff;border:8px solid #95E375;float:left;margin-right:25px;position:relative}
...
.main-timeline9 .circle:before{width:26px;height:30px;background:#95E375;top:0;box-shadow:inset 7px 0 9px -7px #444}
...
.main-timeline9 .year{display:block;padding:10px;margin:10px 0 50px;background:#95E375;border-radius:7px;font-size:25px;color:#fff}
.main-timeline9 .title{font-size:25px;font-weight:700;color:#95E375;margin-top:0}
...
.main-timeline9 .icon{width:25px;height:25px;border-radius:50%;background:#fff;border:4px solid #95E375;position:absolute;top:78px;right:-14px}
.main-timeline9 .icon:before{width:15px;background:#95E375;top:-1px}
